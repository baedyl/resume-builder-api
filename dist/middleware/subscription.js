...
exports.checkPremiumStatus = exports.withPremiumFeatures = exports.requirePremium = void 0;
...
const withPremiumFeatures = async (req, res, next) => {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.sub;
        if (!userId) {
...
exports.withPremiumFeatures = withPremiumFeatures;
