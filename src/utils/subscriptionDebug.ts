...
export async function checkAndFixExpiredSubscriptions() {
...
export async function checkAndFixUserSubscription(user: any) {
                ...
                if (subscriptions.data.length > 0) {
                    ...
                    await prisma.user.update({
                        ...
                        data: {
                            ...
                            planType: 'premium',
                            subscriptionStart: new Date((activeSub as any).current_period_start * 1000),
                            subscriptionEnd: new Date((activeSub as any).current_period_end * 1000)
                        }
                    });
                    ...
                    return {
                        ...
                        newEndDate: new Date((activeSub as any).current_period_end * 1000)
                    };
                } else {
...
async function updateUserToExpired(userId: string, reason: string) {
